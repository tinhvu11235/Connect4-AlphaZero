"""Chapter 6 alpha-beta pruning for depth-limited Connect Four search."""
...
class AlphaBetaAgent(BaseAgent):
    """Preserve ``MiniMax_conn`` and its color-specific pruning bounds."""
    ...
    def select_action(self, env: Any) -> int:
        ...
        for move in legal_actions:
            ...
            opponent_payoff = self._max_payoff_conn(
                env_copy,
                reward,
                done,
                self.depth,
